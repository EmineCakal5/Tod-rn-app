      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <TouchableOpacity
            ...
            <Text style={{ color: 'white', fontWeight: 'bold', marginTop: 70, fontSize: 16 }}>beIN Gurme</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate('TopDiziScreen', { tvShows })}
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate('TopDiziScreen', { tvShows })}>
            <Text style={{ color: 'white', fontWeight: 'bold', marginTop: 70, fontSize: 16 }}>beIN H&E</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate('TopDiziScreen', { tvShows })}
            style={{ marginTop: 70, borderWidth: 1, backgroundColor: '#1f1d17', borderRadius: 17, padding: 4 }} >
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.navigate('TopDiziScreen', { tvShows })}>
            <Text style={{ color: 'white', fontWeight: 'bold', marginTop: 70, fontSize: 16 }}>İyi Yaşam</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => navigation.navigate('TopDiziScreen', { tvShows })}
            style={{ marginTop: 70, borderWidth: 1, backgroundColor: '#1f1d17', borderRadius: 17, padding: 4 }} >
