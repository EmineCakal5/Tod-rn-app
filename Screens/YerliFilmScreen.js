...
export default function YerliFilmScreen({navigation}) {
        ...
        <View style={{flex:1}}>
          ...
          >
            <TouchableOpacity
              ...
              <Text style={{ color: 'white', fontWeight: 'bold', marginTop: 70, fontSize: 16 }}>Türk Sineması</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.navigate('AksiyonScreen', {movie})}
          ...
          >
            <TouchableOpacity
              ...
              <Text style={{ color: 'white', fontWeight: 'bold', marginTop: 70, fontSize: 16 }}>Beyazperdede Şarkıcılar</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => navigation.navigate('AnimasyonScreen', {childrens})}
              style={{ marginTop: 70, borderWidth: 1, backgroundColor: '#1f1d17', borderRadius: 17, padding: 4 }} >
